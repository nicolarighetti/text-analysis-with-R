...
The data set in this tutorial contains US presidential inaugural address texts, and metadata, from 1789 to present.
...
udpipe_english_model <- udpipe_load_model(udpipe_model_en)
```
