...
Click [here](day1-tutorial.qmd#sec-cleaning-and-pre-processing-text-data) to open the tutorial
...
Click [here](day1-tutorial.qmd#sec-basic-text-analysis-techniques) to open the tutorial
...
Click [here](day1-tutorial.qmd#sec-using-dictionaries-in-r) to open the tutorial
